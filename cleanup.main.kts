...
val releases = searchFolders("releases")

printHeader("Release versions")
val releaseVersions = searchLatestVersions(releases)
printFooter()

printHeader("Clean Release Versions")
cleanVersions(releases)
printFooter()
...
fun cleanVersions(folders: Sequence<File>) {
    folders.forEach { folder ->
        ...
        val latestVersion = releaseVersions[name]
